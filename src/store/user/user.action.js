...
//     EMAIL_SIGN_is_start: 'user/EMAIL_SIGN_is_start',
...
export const signUpSuccess=(user,additonalDetails)=>createAction(USER_ACTION_TYPES.SIGN_UP_SUCESS,{user,additonalDetails});
